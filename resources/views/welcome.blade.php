                    ...
                    <div class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        @if (Route::has('login'))
                           ...
                           {{--      @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="text-white text-decoration-none px-3 py-1 rounded-4 bg-secondary fs-5" >Sign up</a>
                                @endif --}}
            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="{{asset('image/Moroccan-teacher-teaching-Arabic.jpg')}}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 >
                                Apprenez à parler l'arabe avec aisance
                            </h1>
                            <ul class="check" >
                                <li>
                    ...
                    <div class="carousel-item">
                        <img src="{{asset('image/Teacher-Explaining-Lessons.jpg')}}" class="d-block w-100" alt="...">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 >
                                Apprenez à parler l'arabe avec aisance
                            </h1>
            ...
            {{-- <ngb-carousel>
              <ng-template ngbSlide>
                <div class="img-slider">
                    <img src="assets/Moroccan-teacher-teaching-Arabic.jpg" alt="Slide 1" class="carousel-img" >
                </div>
              ...
              <ng-template ngbSlide>
                <div class="img-slider">
                    <img src="assets/Teacher-Explaining-Lessons.jpg" alt="Slide 2" class="carousel-img" >
                </div>
                <div class="carousel-caption">
                    <h1>
                     Apprenez à parler l'arabe avec aisance
        ...
        <section id="about" >
            <div class="container mt-5">
                <div class="section-title">
                    <h2>Bienvenue sur la plateforme pédagogique pour apprendrelarabe.fr</h2>
                </div>
                <div class="row no-gutters text-center ">
                    <div class="col-sm-12 col-md-4 col-xl-4">
                        <div class="card">
                            <div class="icon"><i class="fa fa-users fa-2xl" aria-hidden="true"></i></div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4">
                        <div class="card">
                            <div class="icon"><i class="fas fa-user-tie fa-2xl"></i></div>
                            <div class="card-body">
                    ...
                    <div class="col-sm-12 col-md-4 col-xl-4">
                        <div class="card">
                            <div class="icon"><i class="fas fa-chart-line fa-2xl"></i></div>
                            <div class="card-body">
