        ...
        <div class="row">
            ...
            <div class="col sm-12 col-md-6 col-xl-6">
                <button class="btn" id="BtnAddPrixCours" data-bs-toggle="modal" data-bs-target="#ModalAddPrix">
                    ...
                    <span>Ajouter prix cours (change text douha)</span>
                </button>
            </div>
        </div>
        <div class="row">
            ...
            <div class="modal-dialog modal-dialog-settings modal-xl">
                <div class="modal-content">
                    <div class="modal-header text-center">
                        <h5 class="modal-title" id="exampleModalLabel">Ajouter un cours (Change text Douha)</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">

                        <div class="sectiontablecours mt-1 card p-2 shadow" style=" max-height: 310px;">
                            <div class="row">
                                <div class="col-sm-12 col-md-6 col-xl-6">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="sectiontablecours mt-1 card p-2 shadow" style=" max-height: 310px;">
                            ...
                            <button class="Send SendEdit mt-2" >
                                <div class="svg-wrapper-1">
                                    <div class="svg-wrapper">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                            <path fill="none" d="M0 0h24v24H0z"></path>
