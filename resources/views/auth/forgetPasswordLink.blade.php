...
<main class="login-form mt-5">
 <!--  <div class="container">
      <div class="row justify-content-center">
          <div class="col-md-8">
              <div class="card mt-5" style="width:520px; margin:auto">
                  ...
                  <div class="card-body">
                      ...
                      <form action="{{ route('reset.password.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              <label for="email_address" class="col-md-5 col-form-label text-md-right ">Email</label>
                              <div class="col-md-6">
                          ...
                          <div class="form-group row">
                              <label for="password-confirm" class="col-md-5 col-form-label text-md-right">Confirmer le mot de passe</label>
                              <div class="col-md-6">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('reset.password.post') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="password" id="password-confirm" class="form-control" name="password_confirmation" placeholder="Confirmer votre mot de passe" required autofocus>
                                @if ($errors->has('password_confirmation'))
                                    <span class="text-danger">{{ $errors->first('password_confirmation') }}</span>
                                @endif
                            </div>
