...
function print_country(country_class){

    var option_elements = document.getElementsByClassName(country_class);

  for (var j = 0; j < option_elements.length; j++) {
    var option_str = option_elements[j];
    option_str.length = 0;
    option_str.options[0] = new Option('choisissez le pays', '');
